...
### Key Findings
  ...
  5. The scatter plot reveals that over time, game ratings have generally increased over the years. Since it has already been established that the medium of platform or genre lead to marginal difference in rating variation, this  correlation could signify that game quality is a stronger associated factor rather than game distribution.
